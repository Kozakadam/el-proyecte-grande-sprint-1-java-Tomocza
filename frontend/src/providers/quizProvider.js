export async function updateQuizName(quizName, quizId) {
...
export async function saveEmptyQuiz() {
...
export async function copyQuiz(quizId) {
...
export async function fetchModifiedAtById(quizId) {
